...
export default function AppLayout({ children, title = 'marcetime - نظام إدارة المخزون' }) {
    ...
    const navigation = [
        ...
        },
        {
            ...
            description: 'نقطة البيع والمبيعات'
        },
        {
            name: 'إدارة الديون',
            href: '/debts',
            icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
            description: 'متابعة الديون والدفعات'
        },
        {
            name: 'التقارير',
            href: '/reports',
        ...
        },
        {
            ...
            href: '/balance',
            icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
            description: 'إدارة الأرصدة والسحوبات'
        },
        {
            name: 'الإعدادات',
            href: '/settings',
                            ...
                            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-2.5 sm:p-3 border border-blue-100">
                                <div className="flex items-center space-x-2 space-x-reverse">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-xs font-medium text-blue-900 truncate">النسخة المتطورة</p>
                                        <p className="text-xs text-blue-600 truncate">جميع الميزات متاحة</p>
                                    </div>
                                </div>
                            </div>
                        </div>
